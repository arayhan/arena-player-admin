        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-5 rounded-panel border border-border bg-surface p-6">
            <div className="border-b border-border pb-3">
              ...
              <p className="text-xs text-ink-muted">
                Daftar rekening bank yang ditampilkan pada form pembayaran DP customer.
              </p>
            </div>
                ...
                {bankAccounts.map((acc) => (
                  ...
                  >
                    ...
                    <form action={deleteBankAccountAction}>
                      ...
                      <button
                        type="submit"
                        className="inline-flex min-h-[44px] items-center rounded-control border border-red-border bg-red-bg px-3 py-1.5 text-xs font-medium text-red-ink transition-colors hover:bg-red-border/20"
                      >
                        Hapus
                      </button>
                    </form>
