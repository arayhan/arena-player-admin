...
- **Data fetching** — Server Components read Supabase Postgres directly, through `postgres.js`. No client-side fetch of application data, no data-fetching library. Filters and pagination live in the URL, parsed with zod, never in component state
